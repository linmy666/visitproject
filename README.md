...
**visitproject** is the opposite: a single CLI that points at a database or
...
|-------|---------|--------|
| 1 | `visitproject db --type <mysql\|postgres\|sqlite> --conn <str> --tables <a,b,c>` | ✅ scaffold |
| 2 | `visitproject db ...` (full DB-to-MCP) | 🔜 stage 2 |
| 3 | `visitproject watch --dir <path> --type <csv\|xlsx>` | 🔜 stage 3 |
| 4 | `visitproject start --config <path>` (stdio MCP server + TUI dashboard + safety gateway) | 🔜 stage 4 |
